begin
    set PATCH "docs: add README.md to bin/ explaining CLI layout"
    set PROMPT "so stick with bin. make a short readme for bin ??"
    set FILE bin/README.md

    mkdir -p bin

    echo "# \`bin/\` — Project CLI Scripts
...
- This directory follows the **Rails-style convention**: all user-facing commands live here." > $FILE
